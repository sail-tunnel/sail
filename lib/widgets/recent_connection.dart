      ...
      children: [
        Padding(
          ...
          child: Text("Recent Connection",
            style: TextStyle(
              color: isOn? AppColors.GRAY_COLOR: Colors.grey[400],
  ...
  List<Widget> _buildConnections(){
    ...
    for (var i = 1; i < list.length; i++) {
      ...
      list[i]= Material(
        ...
        color: isOn? i==1? Colors.white: Color(0x15000000): AppColors.DARK_SURFACE_COLOR,
        child: InkWell(
          borderRadius: BorderRadius.circular(15),
          onTap: isOn && i==1? null: (){},
          child: Container(
              ...
              children: [
                ...
                Text(
                  ...
                  style: TextStyle(
                    ...
                    fontSize: 14,
                    color: isOn? i==1? Colors.black: AppColors.GRAY_COLOR: Colors.white
                  ),
                ),
